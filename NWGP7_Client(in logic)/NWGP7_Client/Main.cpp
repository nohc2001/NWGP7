...
void GameLogic::UpdateBuffsAndTimers(GameState& state, float deltaTime)
{
	...
	//	}
	//}
	//if (state.boss.attackTime > 0 && state.boss.attackTime < 6) {
	//	if (state.boss.attackTime < 2) {       // 공격 전반부
	//		state.boss.x -= 10;
	//	}
	//	else if (state.boss.attackTime >= 2 && state.boss.attackTime < 4) { // 공격 후반부
	//		state.boss.x += 12;
	//	}
	//	else{
	//		state.boss.x = 820; // 원위치
	//	}
	//}
